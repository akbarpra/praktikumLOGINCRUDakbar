        ...
        <div class="col_3">
            ...
            <div class="col-md-3 widget widget1">
             ...
             <div class= "body">
                ...
                table-striped">
                <tr>
                    <th>NO</th><th>ID</th><th>NAMA BARANG</th><th>HARGA</th><th>STOK</th><th>ID_KATEGORI</th><th>AKSI</th> </tr>
 ...
 <div class="modal fade" id="update_barang">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url('index.php/barang/update_barang')?>" method="post"> <input type="hidden" name="id_barang" id="id_barang">
