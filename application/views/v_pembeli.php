  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="no_telp" class="form-control" placeholder="Nomor Telepon"><br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input id="no_telp" type="text" name="no_telp" class="form-control" placeholder="Nomor Telepon"><br>
