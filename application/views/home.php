      ...
      <div class="col_1">
		        ...
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-8 activity-desc">
	                 	<h5>Ratna Purnamasari</h5>
	                    <p>Pelayanan sangat ramah, dan pengiriman sangat cepat!</p>
	                    <h6>8:03</h6>
	                 </div>
	                 <div class="clearfix"> </div>
                    </div>
	                 ...
	                 <div class="col-xs-8 activity-desc">
	                 	<h5>Joko Pinurbo</h5>
	                    <p>Barangnya sudah sampai bro, sesuai foto, mantab!</p>
	                    <h6>12:53</h6>
	                 </div>
	                 <div class="clearfix"> </div>
                    </div>
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-8 activity-desc">
	                 	<h5>Rani Putrilana</h5>
	                    <p>Sangat puas dengan pelayanan dan barangnya! </p>
	                    <h6>14:43</h6>
	                 </div>
	                 <div class="clearfix"> </div>
                    </div>
			...
			<div class="col-md-4 stats-info">
                <div class="panel-heading">
                    <h4 class="panel-title">Persentase Penjualan Barang</h4>
                </div>
                <div class="panel-body">
                    <ul class="list-unstyled">
                        <li>Iphone 7+<div class="text-success pull-right">12%<i class="fa fa-level-up"></i></div></li>
                        <li>Iphone 5s<div class="text-success pull-right">15%<i class="fa fa-level-up"></i></div></li>
                        <li>OPPO F3<div class="text-success pull-right">18%<i class="fa fa-level-up"></i></div></li>
                        <li>Vivo V5<div class="text-danger pull-right">17%<i class="fa fa-level-down"></i></div></li>
                        <li>Samsung Galaxy 6 Edge<div class="text-danger pull-right">10%<i class="fa fa-level-down"></i></div></li>
                        <li>Iphone 6s+<div class="text-success pull-right">14%<i class="fa fa-level-up"></i></div></li>
	   ...
	   <div class="col-md-4 span_4">
		   ...
		   <div class="col-md-6 col_1_of_2 span_1_of_2">
              <a class="tiles_info tiles_blue">
			    <div class="tiles-head tiles_blue1">
			        <div class="text-center">Diskon</div>
			    </div>
		 ...
		 <div class="box_1">
		  ...
		  <div class="cloud">
			<div class="grid-date">
				<div class="date">
					<p class="date-in">Indonesia</p>
					<span class="date-on">°F °C </span>
					<div class="clearfix"> </div>
				</div>
				<h4>21°<i class="fa fa-cloud-upload"> </i></h4>
			</div>
			<p class="monday">Senin, 5 Maret 2016</p>
		  </div>
		</div>
		<div class="clearfix"> </div>
	    </div>
